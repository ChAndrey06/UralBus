...
namespace DAL.SQL.Migrations
{
    ...
    [Migration("20230712125445_AddClientFIOToOrder")]
    partial class AddClientFIOToOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.CommonConfigs.CommonConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DAL.Entities.Order.Order", b =>
                {
                    ...
                    b.Property<Guid>("EndTripRoutePointId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("StartTripRoutePointId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EndTripRoutePointId");

                    b.HasIndex("PaymentId");

                    b.HasIndex("StartTripRoutePointId");
            ...
            modelBuilder.Entity("DAL.Entities.PassengerData.PassengerData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DAL.Entities.RoutePoint.RoutePoint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 7, 12, 15, 54, 44, 538, DateTimeKind.Utc).AddTicks(7599),
                            IsDeleted = false,
                            Latitude = "55.755826",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 7, 12, 15, 54, 44, 538, DateTimeKind.Utc).AddTicks(7835),
                            IsDeleted = false,
                            Latitude = "59.9342802",
            ...
            modelBuilder.Entity("DAL.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("82448fb7-cbb9-4054-b871-695de72fd61d"),
            ...
            modelBuilder.Entity("DAL.Entities.PersonIdentity.ClientPersonIdentity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("968f48a5-50ba-4eea-b312-e1072dd062b6"),
                            CreatedAt = new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Discriminator = "Client",
                            IsDeleted = false,
                            UserId = new Guid("82448fb7-cbb9-4054-b871-695de72fd61d"),
                            Blacklisted = false,
            ...
            modelBuilder.Entity("DAL.Entities.News.News", b =>
                {
                    b.HasOne("DAL.Entities.Files.S3File", "File")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Entities.Order.Order", b =>
                {
                    ...
                    b.HasOne("DAL.Entities.TripRoute.TripRoutePoint", "EndTripRoutePoint")
                        .WithMany()
                        .HasForeignKey("EndTripRoutePointId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("DAL.Entities.TripRoute.TripRoutePoint", "StartTripRoutePoint")
                        .WithMany()
                        .HasForeignKey("StartTripRoutePointId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("EndTripRoutePoint");

                    b.Navigation("Payment");

                    b.Navigation("StartTripRoutePoint");
            ...
            modelBuilder.Entity("DAL.Entities.TripRoute.TripRoute", b =>
                {
                    b.HasOne("DAL.Entities.Files.S3File", "PopularDestinationPicture")
                        .WithMany()
